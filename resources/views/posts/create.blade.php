...
<body style="background: lightgray">
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                        ...
                        <!-- mengarahkan ke dalam route yang bernama posts.store -->
                         <!-- enctype agar form dapat mengirimkan sebuah file ke dalam server -->
    ...
    <!-- menggunakkan libary tambahan yaitu cek editor agar penulisan konten lebih baik -->
